...
class ControllerSaleOrders extends Controller {
	...
	protected function getList() {
		...
		//print_r($filter_data);
/*
GR, modified this line to call Sub Orders
*/
		$results = $this->model_sale_order->getSubOrders($filter_data);
		//print_r($results);
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'product_total'=>$this->currency->format($result['price'],$result['currency_code'],$result['currency_value']),
		...
		$data['column_product_id'] = 'Product';
		$data['column_product_price'] = 'Price';
		...
		$this->response->setOutput($this->load->view('sale/sub_order_list.tpl', $data));
	}
