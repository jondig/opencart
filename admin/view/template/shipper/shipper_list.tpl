          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($shipper['shipper_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $shipper['shipper_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $shipper['shipper_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $shipper['name']; ?></td>
                  <td class="text-left"><?php echo $shipper['status']; ?></td>
                  <td class="text-left"><?php echo $shipper['date_added']; ?></td>
                  <td class="text-right">
                                    
                    <a href="<?php echo $shipper['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
